				...
				<view class="login__info tn-flex tn-flex-direction-column tn-flex-col-center tn-flex-row-center">
					...
					<block v-if="currentModeIndex === 0">
						<view
							...
							<view class="login__info__item__input__content">
								<input v-model="phoneInput" maxlength="20" placeholder-class="input-placeholder" placeholder="请输入登录手机号码" />
							</view>
						</view>
						...
						<view
							...
							<view class="login__info__item__input__content">
								<input v-model="passwordInput" :password="!showPassword" placeholder-class="input-placeholder"
									placeholder="请输入登录密码" />
							</view>
					...
					<block v-if="currentModeIndex === 1">
						<view
							...
							<view class="login__info__item__input__content">
								<input v-model="phoneInput" maxlength="20" placeholder-class="input-placeholder" placeholder="请输入注册手机号码" />
							</view>
						</view>
					...
					<view
						class="login__info__item__button tn-cool-bg-color-7--reverse"
						hover-class="tn-hover"
						:hover-stay-time="150"
						@click="currentModeIndex === 0 ? login() : register()">
